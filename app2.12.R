...
# Introduction tab -------------------------------------------------------
    tabPanel("Introduction",
             h3("Welcome to the Environmental Impacts of Materials", align = "center"),
         ...
         sidebarLayout(
           sidebarPanel(
             ...
             conditionalPanel(
               ...
               wellPanel(id = "tPanel",style = "overflow-y:scroll; max-height: 250px",
...
# newnew ------------------------------------------------------------------
  ...
  newnew <- eventReactive(input$submitbutton, {
    req(userwastemat())
